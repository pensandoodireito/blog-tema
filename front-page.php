				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="intercambio-logo"
						     style="background-image: url(<?php echo $blog_settings['padrao']; ?>);">

							<a href="<?php echo home_url(); ?>" alt="<?php bloginfo( 'title' ); ?>"><h1 class="logo"
							                                                                            style="background-image: url(<?php echo $blog_settings['logo']; ?>);">
						...
						<div class="row divider-top mt-lg mb-lg text-center">
							<div class="col-xs-12">
								<a href="#" class="btn btn-danger" id="mais-noticias"
								   onclick="return carregar_noticias('.intercambio-content');"><i
